...
# ==========================================
    ...
    if not es_admin_base:
        ...
        with tab_b2:
            ...
            if not df_giradurias.empty: st.info(f"📊 **Estado actual:** {len(df_giradurias):,} registros.")
            archivo_g = st.file_uploader("Cargar Giradurías (.xlsx)", type=["xlsx", "xls"], key="u_giradurias")
